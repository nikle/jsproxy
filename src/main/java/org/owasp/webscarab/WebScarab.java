...
import edu.ubc.webscarab.RemoteDebugPlugin;
...
public class WebScarab {
    ...
    public static void main(String[] args) {
    	...
    	//System.setProperty("WebScarab.ip", "142.103.29.59");
    ...
    public static void loadAllPlugins(Framework framework, UIFramework uif) {
        ...
        RemoteDebugPlugin remote = new RemoteDebugPlugin();
        proxy.addPlugin(remote);       
    }
